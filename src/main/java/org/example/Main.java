...
public class Main {
    public static void main(String[] args) {
        ...
        gis.getFullInfo(circle); // Shape name: Circle, Color: red, opacity: 50, Radius: 4.0, Square: 50.24
        ...
        gis.getFullInfo(oval); // Shape name: Oval, Color: blue, opacity: 99, A: 4.0, B: 9.0, Square: 113.04
        ...
        gis.getFullInfo(quad); // Quad, Color: black, opacity: 100, A: 6.0, Square: 36.0
        ...
        gis.getFullInfo(rectangle); // Rectangle, Color: green, opacity: 0, A: 6.0B: 5.0, Square: 30.0
